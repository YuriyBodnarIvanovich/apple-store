...
import ItemOfProductIphone from "../../../../../Goods/ItemOfProductIphone/ItemOfProductIphone";
...
const CatalogOfProduct = () =>{
    ...
    const catalogOfIphone  = dataIphone.map((item)=>{
    ...
    return(
        <div className={Style.container}>
            <div className={Style.menu_container}>
                ...
                {/* {
                    showMenu ?
                        <div className={`${themeMode ? Style.menu_dark : Style.menu}`}>
