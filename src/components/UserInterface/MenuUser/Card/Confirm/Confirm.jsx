    ...
    if (name !== '' && numberOfPhone !== '') {
      ...
      axios
        ...
        .then(function (response) {
          ...
          upDateUser[0].CartList = props.data.Users[0].CartList.filter(
            (itemCard) => itemCard.idCard !== props.idCard
          ).map((itemCard) => {
            return itemCard;
          });
      ...
      <div className={Style.form_container}>
        ...
        <div className={Style.for_form}>
          <div className={Style.input}>
            ...
            />
            <input
              placeholder={'Input your number of phone'}
              value={numberOfPhone}
              onChange={(event) => {
            ...
            />
            {errorMessage ? (
              <p>Pleas fill your name and number of phone</p>
            ) : null}
          </div>
