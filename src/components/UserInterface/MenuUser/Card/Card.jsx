    ...
    function deleteItem() {
      ...
      axios
        ...
        .then(function (response) {
          ...
          upDateUser[0].CartList = data.Users[0].CartList.filter(
            (itemCard) => itemCard.idCard !== propsItem.idCard
          ).map((itemCard) => {
            return itemCard;
          });
    ...
    return (
      <tr>
        ...
        <td className={Style.color}>
          <div
            style={{
              backgroundColor: `${propsItem.color}`,
              width: '14px',
              height: '14px',
              borderRadius: '5px',
            }}
        ...
        <td>
          <img
            ...
            src='https://img.icons8.com/color/48/000000/checked-radio-button--v1.png'
            alt='alt'
          />
        </td>
        {showConfirm ? (
          <Confirm
            setStatusOfConfirm={setStatusOfConfirm}
            idCard={propsItem.idCard}
            data={data}
            dispatch={dispatch}
          />
