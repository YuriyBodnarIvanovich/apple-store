...
const Blog = () => {
  ...
  const catalogInfo = [
    {
      imgSrc:
        'http://134976.lp.tobiz.net/img/400x580/2656164dde8d87de7ac805b7a449ecec.jpg',
    ...
    {
      imgSrc:
        'http://134976.lp.tobiz.net/img/400x400/283e904e8c4676c5da0406d59c947856.png',
    ...
    {
      imgSrc:
        'http://134976.lp.tobiz.net/img/400x580/1f91178f41bd359ba9d0b65cdde76c42.jpg',
      title:
        'Overview of the Locator app, which replaced Find iPhone and Find Friends',
    ...
    {
      imgSrc:
        'http://134976.lp.tobiz.net/img/400x400/61b6077c892bf65d2e4211f6208f3e6c.jpeg',
      title:
        "Apple Arcade launches on September 19. What to expect from the company's game service",
    ...
    {
      imgSrc:
        'http://134976.lp.tobiz.net/img/470x200/5c5739b3a0b54c3d3ee6fbbd206f9718.png',
      title: 'Meet Apple TV +. Coming soon to your screens',
      info: "Apple Arcade is a new Apple branded service. At launch, it opens access to hundreds of new games that are created exclusively for the company's devices: iPhone and iPad, Mac and Apple TV. We will talk about it in more detail.",
    },
    {
      imgSrc:
        'http://134976.lp.tobiz.net/img/400x300/96736d83f80943ba1aa866e53618ce5a.jpg',
    ...
    {
      imgSrc:
        'http://134976.lp.tobiz.net/img/470x200/cef76f2970341b26234f6770f45fb9f5.jpg',
  ...
  const catalog = catalogInfo.map((item) => {
    return data.darkTheme ? (
      <div className={BlogStyle.item}>
        ...
        <p style={{ color: 'white', opacity: '0.7' }}>{item.info}</p>
      </div>
    ) : (
      <div className={BlogStyle.item}>
        <img src={item.imgSrc} alt='catalog' />
        ...
        <div className={BlogStyle.main}>
          ...
          >
            ...
            <div className={BlogStyle.catalog_container}>
              <div className={BlogStyle.catalog}>{catalog}</div>
            </div>
          </div>
        </div>
      </div>
