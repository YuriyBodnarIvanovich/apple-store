...
const ConnectingWithUs = () =>{
    ...
    return(
        <div className={`${themeMode ? InputStyle.container_dark : InputStyle.container}`}>
            <div className={InputStyle.container_two}>
                <div className={`${themeMode ? InputStyle.container_of_input_dark :InputStyle.container_of_input}`}>
                    <h3>You can consult any specialist at any questions!</h3>
                    <div className={InputStyle.row}>
                        <div className={`${themeMode ? InputStyle.container_of_input_inner_dark 
