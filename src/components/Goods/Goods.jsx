...
const Goods = () =>{
    ...
    const catalogOfIphone  = dataIphone.filter((item)=> item.price > minValue && item.price < maxValue).map((item)=>{
                            ...
                            <samp onClick={()=>{setMenu(!statusOfMenu)}}>{titleOfMenu}</samp>
                            {
                                statusOfMenu ?
                                    <div className={`${dataApple.darkTheme ? Style.menu_type_of_product_dark : Style.menu_type_of_product}`}>
                                        ...
                                        <samp onClick={()=>{setTitleOfMenu('Iphone')}}>Mac</samp>
                                        <samp onClick={()=>{setTitleOfMenu('Iphone')}}>Apple Watch</samp>
                                    </div>
                                    :
                                    null
                            }
