    ...
    return (
      ...
      >
        {props.character?.screen !== '' ? (
          <p>
            <sub>Screen: {props.character.screen}</sub>
          </p>
        ) : null}
        {props.character?.processor !== '' ? (
          <p>
            <sub>Processor: {props.character.processor}</sub>
          </p>
        ) : null}
        {props.character.RAM !== '' ? (
          <p>
            <sub>RAM: {props.character.RAM}</sub>
          </p>
        ) : null}
        {props.character.internalMemory !== '' ? (
          <p>
            <sub>Internal Memory: {props.character.internalMemory}</sub>
          </p>
        ) : null}
